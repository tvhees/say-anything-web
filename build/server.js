...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _common_messages_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../common/messages.js */ \"./src/common/messages.js\");\n/* harmony import */ var _statechart_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./statechart.js */ \"./src/server/statechart.js\");\n\n\n\nfunction initialise(io) {\n  var state = {};\n  _statechart_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].start().onChange(function (context) {\n    state = context;\n  });\n  io.on(_common_messages_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].io.connection, function (socket) {\n    socket.emit(_common_messages_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].io.message, \"User Connected\");\n    socket.on(_common_messages_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].player.join, function () {\n      io.sockets.emit(_common_messages_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].io.message, \"Player joined\");\n    });\n    socket.on(_common_messages_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].player.leave, function () {});\n    socket.on(_common_messages_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].player.setName, function (data) {\n      _statechart_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].send('PLAYER_NAME', {\n        id: socket.id,\n        name: data\n      });\n    });\n  });\n  setInterval(function () {\n    io.sockets.emit(_common_messages_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].io.state, state);\n  }, 1000 / 60);\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  initialise: initialise\n});\n\n//# sourceURL=webpack:///./src/server/server.js?");
